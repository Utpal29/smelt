...
export const MATERIALS: MaterialDef[] = [
  ...
  },
  {
    ...
    name: 'Plant',
    key: '9',
    palette: buildPalette(['#1f7a32', '#36a047', '#6fc45a'], SHADE_COUNT),
    density: 4,
    behavior: 'plant',
    flammable: true,
  },
  {
    ...
    name: 'Steam',
    key: '',
    palette: buildPalette(['#d6f1ff', '#a8d8e8', '#6f9eb0', '#385664'], SHADE_COUNT),
    density: 1,
    behavior: 'gas',
    lifespan: STEAM_LIFESPAN,
    hidden: true,
  },
  {
    id: MUD,
    name: 'Mud',
    key: 'q',
    palette: buildPalette(['#4a3324', '#6b4a32', '#8a6744'], SHADE_COUNT),
    density: 6,
    behavior: 'mud',
    liquidSpread: 1,
  },
